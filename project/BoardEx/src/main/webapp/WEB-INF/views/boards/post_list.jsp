      ...
      <jsp:include page="/WEB-INF/views/include/left.jsp"/>
        <div class="col-xs-12 col-sm-9">
          ...
          <div class="content">
            <div class="row">
              <div class="col-xs-12">
                <c:forEach var="postVOView" items="${postVOViewList}" varStatus="status">
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 style="margin:5px 0px;"><strong><a href="/boards/${postVOView.boardName}/${postVOView.idx}">${postVOView.title}</a></strong><sub style="margin-left:10px;color:#777;">| ${postVOView.boardName}</sub></h4>
                    <div class="text-right" style="font-weight:normal; color:#888;">${postVOView.writeDt}</div>
                  </div>
                ...
                <div class="clearfix text-center">
                  <ul class="pagination pagination-sm no-margin">
                    <c:if test="${fn:length(postVOViewList) > 0}">${viewListPaging}</c:if>
                  </ul>
                </div>
              </div><!-- /col -->
            </div><!-- /row -->
