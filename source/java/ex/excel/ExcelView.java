package com.itw.mng.common.excel.service;
...
public class ExcelView extends AbstractExcelView {
	...
	/** 로거 */
	private final Logger logger = LoggerFactory.getLogger(ExcelView.class);
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook wb, HttpServletRequest request, HttpServletResponse response) {
		...
		titleFont.setBoldweight(Font.BOLDWEIGHT_BOLD); // 볼드체
